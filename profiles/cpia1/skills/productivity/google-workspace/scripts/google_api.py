...
def _extract_message_body(msg: dict) -> str:
    """Extract readable body text from Gmail's nested MIME payload.

    Gmail messages are often multipart/alternative inside multipart/mixed, so a
    shallow scan of payload.parts can miss the actual text/html or text/plain
    part and return an empty body despite a non-empty snippet.
    """
    import html
    import re
